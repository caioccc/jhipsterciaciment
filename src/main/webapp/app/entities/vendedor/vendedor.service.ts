...
export class VendedorService {
    private resourceUrl = SERVER_API_URL + 'api/vendedors';
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/vendedors';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IVendedor[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
