    ...
    describe('Vendedor Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/vendedors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Vendedor', () => {
                service.create(new Vendedor(null)).subscribe(received => {
            ...
            it('should update a Vendedor', () => {
                service.update(new Vendedor(123)).subscribe(received => {
